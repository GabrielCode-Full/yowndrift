...
<div class="container p-3">
    <div class="card">
        ...
        <div class="card-body bg-bokara-grey">
            <form action="/dashboard/{{$post->post_id}}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group">

                    <label for="topic"><span class="badge badge-light mx-1">technology, health, science, society</span></label>
                    ...
                    <textarea class="form-control rounded-0 border-top-0 @error('body') is-invalid @enderror" id="text-area"  rows="5" placeholder="Your text here" name="body" value="{{$post->body}}"></textarea>
